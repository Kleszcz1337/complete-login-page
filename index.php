		...
		<div class="nav">
			<ol>
				...
				<?php
					...
					{
						echo "<li><a href='includes/profilepage.php'>Profile page</a></li>";
		...
		<?php
		    if(isset($_GET["error"]))
		    {
		    	if($_GET["error"] == "Success")
		    	{
					...
					echo "<p>You are corretly login to my page :)</p>";
					echo "<p>More and more work will be done soon.</p>";
				}
				
				if($_GET["error"] == "LogoutCorrectly")
			    {
				    echo "<p>You have logout correctly</p>";
				}
				
				if($_GET["error"] == "none")
			    {
				    echo "<p>You have signUp correctly <br> Now lets login :)</p>";
			    }
		    }
	    ?>
